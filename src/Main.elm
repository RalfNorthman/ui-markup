...
Lärdomar: grott-komp-lex-et är organiserat. Det finns mönster. Det finns gömda skatter. Det finns också gömda faror.
    """
...
blah =
    ...
    En träffad roll-person dör (eller tar allvarlig skada, typ 2T6+4).
    ...
    Det tredje trappsteget ovanifrån är gillrad med en fälla. Om det läggs någon tyngd på den, kommer trappstegen vikas ner och bli en slät stenramp. Spetsar fälls ut ur golvet vid rampens botten när fällan löser ut. En roll-person som glider ner tar T6 i skada (Räddningskast för hälften). Fällan återaktiveras efter 5 rundor.
    ...
    25: Schaktfälla
    Det här rummet har ett falskt golv av tunna stenplattor. En 3o cm bred kant längs med väggarna är säker, men alla andra plattor hålls upp pinnar och tunna metallstänger. En roll-person som stiger in i rummet måste slå Räddningskast för att Ducka eller ta 1T6 skada från fallet och slå igen för att inte ta ytterligare 1T6 från spetsarna på bottnen. De falska plattorna är lätta att upptäcka. En saknas till och med.
    ...
    30: Offergrop
    Offergropen består av en nedsjunken, evig flamma i mitten av en uthuggen, 4½ meter djup grop. Sidorna på gropen lutar nedåt. Flamman får bränsle från naturgas ledd från en djup och uråldrig gruva. Det finns en 60 cm bred avsats runt gropen. Förkolnade ben täcker bottnen. Även om luften är syrefattig här, så är den inte farlig för någonting utanför själva gropen. Varelser i gropen måste slå Räddningskast varje runda eller ta 1T6 temporär Konstitutionsskada. Medvetslösa roll-person-er glider ner till flamman och tar 2T6 skada av elden varje rond.
...
rest =
    ...
    Detta rum tjänar inget särskilt syfte för vättarna, men vid godtycklig tidpunkt kommer 1T6 (exploderande på 6) Svampvättar (sida 12) vara närvarande på natten och 3T6 + 10 (exploderar på en 6) på dagen. Vättarna kommer sova i bägge fallen, men kommer att vakna 2 rundor efter att roll-person-er-na har gjort betydande oväsen i något intilliggande rum. De är nästan osynliga i skräpet. 
    ...
    Den svarta smeten kan angripa samtliga roll-person-er bredvid sig varje rond, med en vanligt attackslag för varje. Om den tränger in en roll-person i ett hörn börjar den omsluta hen och gör 3T6 skada per rond. Metall- eller trävapen som träffar den löses upp i 10% av fallen.
    Mumiespillror
